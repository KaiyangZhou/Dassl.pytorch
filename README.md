...
## What's new
- [Mar 2021] Happy to announce that we have just released a survey on the topic of domain generalization at https://arxiv.org/abs/2103.02503, which summarizes the ten-year development in this topic with coverage on a brief history, datasets, methodologies and potential directions, etc.
