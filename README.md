...
## What's new
- [Jun 2021] `v0.2.6`: Merges `MixStyle2` to `MixStyle`. A new variable `self.mix` is used to switch between random mixing and cross-domain mixing. See [mixstyle.py](dassl/modeling/ops/mixstyle.py) for more details.
