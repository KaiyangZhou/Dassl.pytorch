...
## What's new
- [Oct 2021]: `v0.4.3`: Copy the attributes in `self.dm` (data manager) to `SimpleTrainer` and remove `self.dm`. From now on, you can build data loaders from any source you like rather than being forced to use `DataManager`.
